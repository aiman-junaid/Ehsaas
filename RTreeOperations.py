...
class TreeOp:
    def __init__(self,path=None):
        ...
        for i, row in df.iterrows():
            ...
            a = g.bbox
            x1,y1 = self.convertSphericalToCartesian(a["northeast"][0],a["northeast"][1])
            x2,y2 = self.convertSphericalToCartesian(a["southwest"][0],a["southwest"][1])
            ...
            entry.setData(Name,Address,Province,Area,Cell,Landline,Latitude,Longitude,StoreType)
